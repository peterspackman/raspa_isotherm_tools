            ...
            if len(args.plot) == 0:
                ...
                try:
                    ...
                    if len(frameworks) == 1 and len(components) == 1:
                        ...
                        print("Multiple frameworks/components found. Please specify: --plot FRAMEWORK COMPONENT")
        ...
        try:
            ...
            if args.export_isotherm_csv:
                ...
                if len(frameworks) == 1 and len(components) == 1:
                    ...
                    print("Multiple frameworks/components found. Cannot auto-detect for export.")
                    print(f"Available frameworks: {frameworks}")
                    print(f"Available components: {components}")
                    return 1
